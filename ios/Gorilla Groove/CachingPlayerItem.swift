...
// Stolen from https://github.com/neekeetab/CachingPlayerItem/blob/master/CachingPlayerItem.swift who didn't make it available as a library.
// It's just one file though, and I've made no modifications to it aside from this comment
