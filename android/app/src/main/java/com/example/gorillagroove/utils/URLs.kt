...
object URLs {
    ...
    const val PLAYLIST_BASE = "$BASE_URL/api/playlist/track?"
    const val LIBRARY = "$BASE_URL/api/track?sort=artist,asc&sort=album,asc&sort=trackNumber,asc&size=600&page=0"
